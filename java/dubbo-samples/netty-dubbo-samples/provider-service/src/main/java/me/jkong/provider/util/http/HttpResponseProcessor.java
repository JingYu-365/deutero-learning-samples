package me.jkong.provider.util.http;
...
import me.jkong.provider.constant.CodeEnum;
...
public class HttpResponseProcessor {
    ...
    /**
     * 将 org.apache.http.HttpResponse 转为 io.netty.handler.codec.http.FullHttpResponse
     *
     * @param httpResponse org.apache.http.HttpResponse
     * @return io.netty.handler.codec.http.FullHttpResponse
     */
    public static FullHttpResponse convertToFullHttpResponse(org.apache.http.HttpResponse httpResponse) {
        ...
        String contentType = getContentType(allHeaders);
        return prepareResponse(respStr, HttpResponseStatus.valueOf(statusLine.getStatusCode()), contentType);
    }
     ...
     * @return io.netty.handler.codec.http.FullHttpResponse
     */
    public static FullHttpResponse convertToFullHttpResponse(org.apache.http.HttpResponse httpResponse, Map<String, Object> body) {
        ...
        String contentType = getContentType(allHeaders);
        return prepareResponse(new Gson().toJson(body),
                HttpResponseStatus.valueOf(statusLine.getStatusCode()), contentType);
    }

    private static String getContentType(Header[] allHeaders) {
        String contentType = RESPONSE_CONTENT_TYPE_APPLICATION_JSON;
        for (Header header : allHeaders) {
            if (header.getName().toLowerCase().contentEquals(CONTENT_TYPE.toLowerCase())) {

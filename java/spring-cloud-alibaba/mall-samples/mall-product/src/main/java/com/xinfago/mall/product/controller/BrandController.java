package com.xinfago.mall.product.controller;
...
public class BrandController {
     ...
     */
    @RequestMapping("/save")
    public R save(@Validated(value = {BaseGroup.class, AddGroup.class}) @RequestBody BrandEntity brand) {
    ...
    public R update(@Validated(value = {BaseGroup.class, UpdateGroup.class}) @RequestBody BrandEntity brand) {

package me.jkong.hbase.basic.demo2;
...
//            deleteTable("user_table");
            ...
            User user = new User("001", "xiaoming", "123456", "man", "20", "13355550021", "1@csdn.com");
            insertData("user_table", user);
            User user2 = new User("002", "xiaohong", "654321", "female", "19", "18757912212", "2@csdn.com");
            insertData("user_table", user2);
            User user3 = new User("003", "xiaoxiao", "1234567", "man", "20", "13435522221", "3@csdn.com");
            insertData("user_table", user3);
            User user4 = new User("004", "xiaoda", "6543217", "female", "18", "18753562212", "4@csdn.com");
            insertData("user_table", user4);
            User user5 = new User("005", "xiaohahah", "1234568", "man", "21", "13351234021", "5@csdn.com");
            insertData("user_table", user5);
            User user6 = new User("006", "xiaokongkong", "6543218", "female", "38", "18757958762", "6@csdn.com");
            insertData("user_table", user6);
            ...
            User user8 = getDataByRowKey("user_table", "user-001");
            ...
            User user9 = new User("test-007", "xiaoguang", "789012", "man", "22", "12312132214", "856832@csdn.com");
            insertData("user_table", user9);
            List<User> list2 = getAllData("user_table");
            System.out.println("--------------------插入测试数据后--------------------");
            for (User user10 : list2) {
                System.out.println(user10.toString());
            }
            deleteByRowKey("user_table", "user-test-007");
            List<User> list3 = getAllData("user_table");
            System.out.println("--------------------删除测试数据后--------------------");
            for (User user11 : list3) {
    ...
    public static Connection initHbase() throws IOException {
        ...
        configuration.set("hbase.zookeeper.quorum", "10.10.27.47");
        //集群配置↓
